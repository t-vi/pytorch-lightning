...
def test_automatic_optimization_raises(tmpdir):
    ...
    model = TestModel()
    trainer = Trainer(default_root_dir=tmpdir, limit_train_batches=2, limit_val_batches=2, accumulate_grad_batches=2)
...
def test_toggle_untoggle_2_optimizers_no_shared_parameters(tmpdir):
    ...
    trainer = Trainer(
        max_epochs=1, default_root_dir=tmpdir, limit_train_batches=8, accumulate_grad_batches=1, limit_val_batches=0
    )
    trainer.fit(model)
...
def test_toggle_untoggle_3_optimizers_shared_parameters(tmpdir):
    ...
    trainer = Trainer(max_epochs=1, default_root_dir=tmpdir, limit_train_batches=8, accumulate_grad_batches=1)
