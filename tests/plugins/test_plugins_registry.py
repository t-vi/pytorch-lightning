...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("deepspeed_stage_2_offload", {"stage": 2, "cpu_offload": True}),
        ("deepspeed_stage_3", {"stage": 3}),
        ("deepspeed_stage_3_offload", {"stage": 3, "cpu_offload": True}),
    ],
)
...
def test_ddp_training_type_plugins_registry_with_trainer(tmpdir):
    ...
    trainer = Trainer(default_root_dir=tmpdir, plugins="ddp_find_unused_parameters_false")
